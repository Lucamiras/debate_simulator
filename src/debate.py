...
class Debate:
    """A class representing a debate simulator.
    ...
    Attributes:
        ...
        number_of_rounds (int): The number of rounds in the debate.
        prompts (dict): A dictionary containing various prompts for the debate.
        debate_dictionary (dict): A dictionary representing the debate with the following keys:
        ...
        full_transcript (dict): A dictionary representing the full transcript of the debate.
        arg_counter (list): A list containing the counters for the favor and opposition arguments.

    Methods:
        load_model: Load a model.
        load_prompts: Load the prompts for the debate.
        initialize_debate_dictionaries: Initialize the debate dictionaries.
        summarize_arguments: Summarize the arguments for a given side in the debate.
        opening_arguments: Generate opening arguments for a debate.
        debate: Simulate a debate between two sides.
        wrap_up: Wrap up the debate and return a summary.
    """
